...
if __name__ == "__main__":
    while True:
        choice = input('Ввести связи согласно Варианту №14 или задать связи вручную? (0/1) > ')
        if choice == '1':
            ...
            # Мой вариант
            # e_connections = {'q0': ['q1:0', 'q2:1'],
            #                  'q1': [f'q2:{chr(949)}'],  # chr(949) = ε
            #                  'q2': ['q2:0', 'q1:1']}
            # endpoint = 'q2'
            # amount_points = len(e_connections)
            # q_points = ['q' + str(_) for _ in range(amount_points)]
            # th = ['q', '0', '1', f'{chr(949)}']
            # alphabet = ['0', '1', f'{chr(949)}']

            # Вариант Маши
            # e_connections = {'q0': ['q1:0', 'q3:1'],
            #                  'q1': ['q1:1', f'q2:{chr(949)}', 'q3:0'],  # chr(949) = ε
            #                  'q2': ['q3:1'],
            #                  'q3': ['i']}
            # endpoint = 'q2'.split()
            # amount_points = len(e_connections)
            ...
            # Вариант Стаси
            # e_connections = {'q0': [f'q1:{chr(949)}', 'q3:a'],
            #                  'q1': ['q1:b', f'q2:a'],  # chr(949) = ε
            #                  'q2': ['q3:b'],
            #                  'q3': [f'q2:{chr(949)}']}
            # endpoint = 'q2'.split()
            # amount_points = len(e_connections)
            ...
            # Вариант Радика:
            e_connections = {'q0': ['q0:b', 'q1:a', f'q2:{chr(949)}'],
                             'q1': [f'q0:{chr(949)}', 'q2:b'],  # chr(949) = ε
                             'q2': ['q0:b']}
            endpoint = 'q2'.split()
            amount_points = len(e_connections)
            q_points = ['q' + str(_) for _ in range(amount_points)]
    ...
    while True:
        choice = input('Ввести слово для проверки/Выйти?(0/any): ')
        if choice == '0':
